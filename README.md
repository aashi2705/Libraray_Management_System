...
This system provides an efficient way to track books and student records. The project demonstrates the use of object-oriented programming concepts, data structures, and file/record management techniques to simulate the core functionality of a library management system.

The application maintains:

 1- A collection of books available in the library.
 
 2-  Student records for issued books.
 
 3- Real-time inventory updates.
 
 4- Book issue and return history during program execution.
